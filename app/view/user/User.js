Ext.define('JxkpApp.view.user.User' ,{
    extend: 'Ext.grid.Panel', 
    alias : 'widget.userlist', //使用alias来定义一个别名，这个时候，我们的类可以使用Ext.create()和Ext.widget()创建，在其他组件的子组件中，也可以使用xtype来创建。
    title : 'All Users', 
        ...
        Ext.apply(me, {
            ...
            columns : [
                    ...
                    tbar : [
                                ...
                                {xtype: 'numberfield', fieldLabel: '工号', labelWidth:30, width: 100},
                                {text:'搜索', iconCls:'search', action: 'user_search'},
