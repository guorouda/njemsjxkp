Ext.define('JxkpApp.view.crowdshare.MonthSalary' ,{
    extend: 'Ext.grid.Panel', 
    alias : 'widget.monthsalarylist', //使用alias来定义一个别名，这个时候，我们的类可以使用Ext.create()和Ext.widget()创建，在其他组件的子组件中，也可以使用xtype来创建。
    title : '待结', 
