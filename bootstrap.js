...
Ext.Loader.addClassPathMappings({
  ...
  "JxkpApp": "app",
  "JxkpApp.store.Dictoinarys": "app/store/Dictionarys.js",
  "JxkpApp.view.DeptFormManagement": "app/view/user/DeptFormManagement.js",
  "MyRecord": "app/view/user/Authorization.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "JxkpApp.Application": [],
  "JxkpApp.controller.Attendence": [],
  "JxkpApp.controller.Check": [],
  "JxkpApp.controller.Deploy": [],
  "JxkpApp.controller.Main": [],
  "JxkpApp.controller.Postman": [],
  "JxkpApp.controller.Score": [],
  "JxkpApp.controller.User": [],
  "JxkpApp.model.Attendence": [],
  "JxkpApp.model.Check": [],
  "JxkpApp.model.Dept": [],
  "JxkpApp.model.Dictionary": [],
  "JxkpApp.model.InnerSalary_fail_log": [],
  "JxkpApp.model.List": [],
  "JxkpApp.model.Menu": [],
  "JxkpApp.model.Salary": [],
  "JxkpApp.model.Score": [],
  "JxkpApp.model.User": [],
  "JxkpApp.model.crowdshare.AppSalary": [],
  "JxkpApp.model.crowdshare.DeployQuery": [],
  "JxkpApp.model.crowdshare.DeployQueryDetail": [],
  "JxkpApp.model.crowdshare.Mail": [],
  "JxkpApp.model.crowdshare.Pay": [],
  "JxkpApp.model.crowdshare.User": [],
  "JxkpApp.store.AllDepts": [],
  "JxkpApp.store.Attendences": [],
  "JxkpApp.store.Authorizations": [],
  "JxkpApp.store.Checks": [],
  "JxkpApp.store.Depts": [],
  "JxkpApp.store.Dictoinarys": [],
  "JxkpApp.store.Directions": [],
  "JxkpApp.store.Genders": [],
  "JxkpApp.store.InnerSalary_fail_logs": [],
  "JxkpApp.store.Lists": [],
  "JxkpApp.store.ManagerDepts": [],
  "JxkpApp.store.Menus": [],
  "JxkpApp.store.NewDepts": [],
  "JxkpApp.store.PersonSalary": [],
  "JxkpApp.store.Salarys": [],
  "JxkpApp.store.Scores": [],
  "JxkpApp.store.SearchUsers": [],
  "JxkpApp.store.Segments": [],
  "JxkpApp.store.States": [],
  "JxkpApp.store.Users": [],
  ...
  "JxkpApp.store.crowdshare.AppSalarys": [],
  "JxkpApp.store.crowdshare.DeployQueryDetails": [],
  "JxkpApp.store.crowdshare.DeployQuerys": [],
  "JxkpApp.store.crowdshare.Mails": [],
  "JxkpApp.store.crowdshare.Users": [],
  "JxkpApp.view.DeptFormManagement": [],
  "JxkpApp.view.Hr": [],
  "JxkpApp.view.Main": [],
  "JxkpApp.view.Viewport": [],
  "JxkpApp.view.combo.Dept": [],
  "JxkpApp.view.combo.DeptType": [],
  "JxkpApp.view.combo.Direction": [],
  "JxkpApp.view.combo.Gender": [],
  "JxkpApp.view.combo.Level": [],
  "JxkpApp.view.combo.Segment": [],
  "JxkpApp.view.combo.State": [],
  "JxkpApp.view.combo.Station": [],
  "JxkpApp.view.crowdshare.DaySalary": [],
  "JxkpApp.view.crowdshare.Deploy": [],
  "JxkpApp.view.crowdshare.DeployForm": [],
  "JxkpApp.view.crowdshare.DeployQuery": [],
  "JxkpApp.view.crowdshare.DeployWithForm": [],
  "JxkpApp.view.crowdshare.HandBack": [],
  "JxkpApp.view.crowdshare.HandToPostman": [],
  "JxkpApp.view.crowdshare.HandToPostmanAll": [],
  "JxkpApp.view.crowdshare.HandToPostmanDetail": [],
  "JxkpApp.view.crowdshare.MonthSalary": [],
  ...
  "JxkpApp.view.crowdshare.RegisterWithForm": [],
  "JxkpApp.view.crowdshare.ReportDelivery": [],
  "JxkpApp.view.crowdshare.ReportDeliveryFail": [],
  "JxkpApp.view.crowdshare.ReportDeliveryOK": [],
  "JxkpApp.view.user.Attendence": [],
  "JxkpApp.view.user.Authorization": [],
  "JxkpApp.view.user.ChangePassword": [],
  "JxkpApp.view.user.Charge": [],
  "JxkpApp.view.user.Check": [],
  "JxkpApp.view.user.CheckDept": [],
  "JxkpApp.view.user.CheckSingle": [],
  "JxkpApp.view.user.Dept": [],
  "JxkpApp.view.user.DeptManagement": [],
  "JxkpApp.view.user.Dictionary": [],
  "JxkpApp.view.user.Import": [],
  "JxkpApp.view.user.InnerSalary_fail_log": [],
  "JxkpApp.view.user.List": [],
  "JxkpApp.view.user.Login": [],
  "JxkpApp.view.user.ManagerDept": [],
  "JxkpApp.view.user.MyForm": [],
  "JxkpApp.view.user.MyFormAuthorization": [],
  "JxkpApp.view.user.PersonSalary": [],
  "JxkpApp.view.user.PersonSalaryCheck": [],
  "JxkpApp.view.user.Salary": [],
  "JxkpApp.view.user.SalaryForm": [],
  "JxkpApp.view.user.SalaryListForm": [],
  "JxkpApp.view.user.Score": [],
  "JxkpApp.view.user.TextField": [],
  "JxkpApp.view.user.User": [],
  "JxkpApp.view.user.UserAuthorization": [],
  "JxkpApp.view.user.UserAuthorizationForm": [],
  "JxkpApp.view.user.UserDeleteForm": [],
  "JxkpApp.view.user.UserDeleteFormList": [],
  "JxkpApp.view.user.UserForm": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "JxkpApp.view.combo.DeptType": [
    "widget.combodepttype"
  ],
  "JxkpApp.view.combo.Direction": [
    "widget.combodirection"
  ],
  "JxkpApp.view.combo.Gender": [
    "widget.combogender"
  ],
  ...
  "JxkpApp.view.crowdshare.DaySalary": [
    "widget.daysalarylist"
  ],
  "JxkpApp.view.crowdshare.Deploy": [
    "widget.deploylist"
  ],
  "JxkpApp.view.crowdshare.DeployForm": [
    "widget.deployformlist"
  ],
  "JxkpApp.view.crowdshare.DeployQuery": [
    "widget.deployquerylist"
  ],
  "JxkpApp.view.crowdshare.DeployWithForm": [
    "widget.deploywithformlist"
  ],
  "JxkpApp.view.crowdshare.HandBack": [
    "widget.handbacklist"
  ],
  "JxkpApp.view.crowdshare.HandToPostman": [
    "widget.handtopostmanlist"
  ],
  "JxkpApp.view.crowdshare.HandToPostmanAll": [
    "widget.handtopostmanall"
  ],
  "JxkpApp.view.crowdshare.HandToPostmanDetail": [
    "widget.handtopostmandetail"
  ],
  "JxkpApp.view.crowdshare.MonthSalary": [
    "widget.monthsalarylist"
  ],
  "JxkpApp.view.crowdshare.RealDelivery": [
    "widget.realdelivery"
  ],
  "JxkpApp.view.crowdshare.RealDeliveryFail": [
    "widget.realdeliveryfail"
  ],
  "JxkpApp.view.crowdshare.RealDeliveryOK": [
    "widget.realdeliveryok"
  ],
  "JxkpApp.view.crowdshare.Register": [
    "widget.registerlist"
  ],
  "JxkpApp.view.crowdshare.RegisterForm": [
    "widget.registerformlist"
  ],
  "JxkpApp.view.crowdshare.RegisterWithForm": [
    "widget.registerwithformlist"
  ],
  "JxkpApp.view.crowdshare.ReportDelivery": [
    "widget.reportdelivery"
  ],
  "JxkpApp.view.crowdshare.ReportDeliveryFail": [
    "widget.reportdeliveryfail"
  ],
  "JxkpApp.view.crowdshare.ReportDeliveryOK": [
    "widget.reportdeliveryok"
  ],
  "JxkpApp.view.user.Attendence": [
    "widget.attendencelist"
  ],
  "JxkpApp.view.user.Authorization": [
    "widget.authorizationlist"
  ],
  "JxkpApp.view.user.ChangePassword": [
    "widget.changepasswordlist"
  ],
  "JxkpApp.view.user.Charge": [
    "widget.usercharge"
  ],
  ...
  "JxkpApp.view.user.CheckDept": [
    "widget.usercheckdept"
  ],
  "JxkpApp.view.user.CheckSingle": [
    "widget.checksinglelist"
  ],
  "JxkpApp.view.user.Dept": [
    "widget.userdept"
  ],
  "JxkpApp.view.user.DeptManagement": [
    "widget.deptmanagementlist"
  ],
  "JxkpApp.view.user.Dictionary": [
  ...
  "JxkpApp.view.user.InnerSalary_fail_log": [
    "widget.innersalary_fail_loglist"
  ],
  "JxkpApp.view.user.List": [
    "widget.listlist"
  ],
  ...
  "JxkpApp.view.user.ManagerDept": [
    "widget.usermanagerdept"
  ],
  "JxkpApp.view.user.MyForm": [
    "widget.usermyform"
  ],
  "JxkpApp.view.user.MyFormAuthorization": [
    "widget.usermyformauthorization"
  ],
  "JxkpApp.view.user.PersonSalary": [
    "widget.personsalarylist"
  ],
  "JxkpApp.view.user.PersonSalaryCheck": [
    "widget.personsalarychecklist"
  ],
  "JxkpApp.view.user.Salary": [
    "widget.salarylist"
  ],
  ...
  "JxkpApp.view.user.SalaryListForm": [
    "widget.salaryformlist"
  ],
  "JxkpApp.view.user.Score": [
    "widget.scorelist"
  ],
  "JxkpApp.view.user.TextField": [
    "widget.usertextfiled"
  ],
  "JxkpApp.view.user.User": [
    "widget.userlist"
  ],
  "JxkpApp.view.user.UserAuthorization": [
    "widget.userauthorizationlist"
  ],
  "JxkpApp.view.user.UserAuthorizationForm": [
    "widget.userauthorizationformlist"
  ],
  "JxkpApp.view.user.UserDeleteForm": [
    "widget.userdeleteform"
  ],
  "JxkpApp.view.user.UserDeleteFormList": [
    "widget.userdeleteformlist"
  ],
  "JxkpApp.view.user.UserForm": [
    "widget.userformlist"
  ],
